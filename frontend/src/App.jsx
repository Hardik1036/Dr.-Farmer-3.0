    ...
    try {
      ...
      if (data && data.pathology_detected) {
        ...
        diagnosisData = {
          ...
          confidenceLevel: data.confidence_level || (data.confidence_score >= 0.70 ? 'high' : data.confidence_score >= 0.45 ? 'moderate' : 'low'),
          verificationStatus: data.verification_status || 'VERIFIED',
          isConfident: data.is_confident !== undefined ? data.is_confident : true,
          advisory: data.advisory || '',
          advisoryHi: data.advisory_hi || '',
          imageUrl: imageUrl,
